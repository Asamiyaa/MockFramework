 ...
 *
 *           数据库设计的方法和步骤：https://blog.csdn.net/littledream/article/details/4243570
 *                               https://blog.csdn.net/littledream/article/details/4243613
 *
 *           数据库设计中常见表结构的设计技巧
 *           https://blog.csdn.net/littledream/article/details/4243517
 *           树型关系的数据表 - 商品信息表的设计 - 多用户及其权限管理的设计 - 简洁的批量m:n设计 - 冗余数据的取舍
 *
 *           数据库设计规范（命名规范）https://blog.csdn.net/littledream/article/details/5300069
 *
 *           ----总体：https://blog.csdn.net/littledream/category_550687.html ----
 *
 *              表的设计优化： https://blog.csdn.net/jack__frost/article/details/72672252
 *
 *
